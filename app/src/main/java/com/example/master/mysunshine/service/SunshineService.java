package com.example.master.mysunshine.service;
...
/**
 * Created by Master on 30/07/2015.
 */
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                this.getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI,values);
            }
